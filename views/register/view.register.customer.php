...
<body>
    ...
    <form action="#" method="post" >
        <div class="form_left">
            ...
            <div class="icon">
                <img src="../../assets/icon-google.png" alt="" width="7%">
                <img src="../../assets/icon-telegram.png" alt="" width="7%">
                <img src="../../assets/icon-twifter.png" alt="" width="8%">
            </div>
        </div>
        <div class="form_right">
            <div class="container">
                ...
                <a href="<?php if($isFound){ echo '../home/home.php';} else{echo '#';}?>"><button class=" login form-control ">SUBMIT</button></a>
            </div>
        </div>
    </form>
</body>
