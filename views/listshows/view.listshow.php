...
<body>
    ...
    foreach($img as $photo){
            ...
            if($photo['movie_id'] == $movie['movie_id']){ 
                $image = '../../assets/' . $photo['filename'];
            }
        }
              ?>
            <section class="cards">
                ...
                <article class="card card--1">
                    ...
                    <a href="/" class="card_link text-decoration-none" name=""
                        ...
                        <img src="<?php echo $image; ?>" alt="" class="card__img--hover">

                        <div class="card__info">
                            <h3 class="card__title"><?= $movie["movie_title"]?></h3>
                            <h3 class="card__category "><?= $movie["decription"]?></h3>
                    </a>
        </div>
        </article>
        </section>
