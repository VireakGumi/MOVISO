    ...
    <div class="form-movie">
        <div class="movie-left">
            <div class="movies">
                <div id="title-field">
                    ...
                    <small class="text-danger">
                        <?=!empty($title_error) ? $title_error : "<p>.</p>" ?>
                    </small>
                ...
                <div id="price-field">
                    Price<input type="text" id="price_value" class="form-control" name="price" onkeyup="moviePrice()"
                        onclick="normal('price-field')">
                    <span id="icons">
                        <i class="fa fa-check-circle"></i>
                        <i class="fa fa-exclamation-circle"></i>
                    </span>
                    <small class="text-danger">
                        <?=!empty($price_error) ? $price_error : "<p>.</p>" ?>
                    </small>
            ...
            <div class="movies">
                <div id="genre-field">
                    Genre<input type="text" id="genre_value" class="form-control" name="genre" onkeyup="movieGenre()"
                        onclick="normal('genre-field')">
                    <span id="icons">
                        <i class="fa fa-check-circle"></i>
                        <i class="fa fa-exclamation-circle"></i>
                    </span>
                    <small class="text-danger">
                        <?=!empty($genre_error) ? $genre_error : "<p>.</p>" ?>
                    </small>
                ...
                <div id="duration-field">
                    ...
                    <small class="text-danger">
                        <?=!empty($duration_error) ? $duration_error : "<p>.</p>" ?>
                    </small>
            ...
            <div class="movies">
                ...
                <div id="country-field">
                    ...
                    <small class="text-danger">
                        <?=!empty($country_error) ? $country_error : "<p>.</p>" ?>
                    </small>
            ...
            <div class="movies">
                <div id="date-field">
                    ...
                    <small class="text-danger">
                        <?=!empty($datetime_error) ? $datetime_error : "<p>.</p>" ?>
                    </small>
                ...
                <div id="numberticket-field">
                    ...
                    <small class="text-danger">
                        <?=!empty($numberTicket_error) ? $numberTicket_error : "<p>.</p>" ?>
                    </small>
            ...
            <div class="movies">
                <div id="cinemaname-field">
                    ...
                    <small class="text-danger">
                        <?=!empty($cinemaName_error) ? $cinemaName_error : "<p>.</p>" ?>
                    </small>
                ...
                <div id="production-field">
                    ...
                    <small class="text-danger">
                        <?=!empty($production_error) ? $production_error : "<p>.</p>" ?>
                    </small>
        ...
        <div class="movie-right">
            ...
            <div id="trailer-field">
                ...
                <small class="text-danger">
                    <?=!empty($linkTrailer_error) ? $linkTrailer_error : "<p>.</p>" ?>
                </small>
            ...
            <div id="description-field">
                ...
                <small class="text-danger">
                    <?=!empty($description_error) ? $description_error : "<p>.</p>" ?>
                </small>
