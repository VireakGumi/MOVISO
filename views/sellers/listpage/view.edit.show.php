...
<form action="/update" method="POST" enctype="multipart/form-data" class="list_movie">
    <div class="d-flex flex-column">
        ...
        <div class="form-movie d-flex">
            <div class="movie-left d-flex flex-column">
                <div class="movies">
                    <div id="title-field">
                ...
                <div class="movies">
                    <div id="genre-field">
                        Genre<input type="text" id="genre_value" class="form-control" name="genre"
                            ...
                            value="<?= isset($_GET["id"])? $movie["genre"]:null?>">
                        <span id="icons">
                            <i class="fa fa-check-circle"></i>
                            <i class="fa fa-exclamation-circle"></i>
                        </span>
                    ...
                    <div id="duration-field">
                        Duration<input type="text" id="duration_value" class="form-control" name="duration"
                            ...
                            value="<?= isset($_GET["id"])? $movie["duration"]:null?>">
                        <span id="icons">
                            <i class="fa fa-check-circle"></i>
                            <i class="fa fa-exclamation-circle"></i>
                        </span>
                ...
                <div class="movies">
                    ...
                    <div id="country-field">
                        Country<input type="text" id="country_value" class="form-control" name="country"
                            ...
                            value="<?= isset($_GET["id"])? $movie["country"]:null?>">
                        <span id="icons">
                            <i class="fa fa-check-circle"></i>
                            <i class="fa fa-exclamation-circle"></i>
                        </span>
                ...
                <div class="movies">
                    <div id="date-field">
                        Date Time<input type="datetime-local" id="date_value" class="form-control" name="datetime"
                            ...
                            value="<?= isset($_GET["id"])? $movie["date_time"]:null?>">
                        <span id="icons">
                            <i class="fa fa-check-circle"></i>
                            <i class="fa fa-exclamation-circle"></i>
                        </span>
                    ...
                    <div id="numberticket-field">
                        Number Ticket<input type="number" id="numberticket_value" class="form-control"
                            name="numberticket" onkeyup="movieTime()" onclick="normal('numberticket-field')"
                ...
                <div class="movies">
                    <div id="cinemaname-field">
                        Cinema Name<input type="text" id="cinema_name_value" class="form-control" name="cinemaname"
                            ...
                            value="<?= isset($_GET["id"])? $vanue["cinema_name"]:null?>">
                        <span id="icons">
                            <i class="fa fa-check-circle"></i>
                            <i class="fa fa-exclamation-circle"></i>
                        </span>
            ...
            <div class="movie-right">
                <div id="addres-field">
                    Address<input type="text" id="address_value" class="form-control" name="address"
                        ...
                        value="<?= isset($_GET["id"])? $vanue["cinema_address"]:null?>">
                    <span id="icons">
                        <i class="fa fa-check-circle"></i>
                        <i class="fa fa-exclamation-circle"></i>
                    </span>
                ...
                <div id="description-field">
                    Description<textarea name="description" id="description_value" class="form-control" cols="30"
                        ...
                        value=""><?= isset($_GET["id"])? $movie["descriptions"]:''?></textarea>
                    <span id="icons">
                        <i class="fa fa-check-circle"></i>
                        <i class="fa fa-exclamation-circle"></i>
                    </span>
